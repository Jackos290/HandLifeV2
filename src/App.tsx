...
const TRAINING_EXERCISE_LIBRARY = [
  ...
  ['Échauffement', 'Passe en étoile', 10, 'Former une étoile avec plusieurs plots. Les joueurs passent puis suivent leur ballon pour réveiller les appuis et la lecture.'],
  ['Échauffement', 'Épervier avec ballon', 8, 'Les joueurs traversent une zone en dribble pendant que les défenseurs tentent de gêner. Objectif : lever la tête et changer de rythme.'],
  ['Échauffement', 'Activation gardien + tireurs', 10, 'Les tireurs enchaînent des tirs contrôlés sur zones annoncées. Le gardien travaille placement, rythme et premières sensations.'],
  ['Échauffement', 'Appuis miroir', 8, 'Par deux, un joueur guide les déplacements et l’autre l’imite. Travailler réactivité, équilibre et déplacements latéraux.'],
  ['Échauffement', 'Relais passes et sprint', 10, 'Deux équipes en relais. Chaque joueur réalise une passe précise, sprinte autour d’un plot puis revient transmettre.'],
  ['Dribble', 'Dribble avec changement de main', 10, 'Les joueurs avancent en changeant de main à chaque plot. Insister sur protection du ballon et regard vers l’avant.'],
  ['Dribble', 'Dribble stop-and-go', 8, 'Au signal, les joueurs stoppent net puis repartent fort. Objectif : maîtriser arrêt, reprise et accélération.'],
  ['Dribble', 'Duel dribble + passe', 12, 'L’attaquant doit battre son défenseur puis trouver un partenaire démarqué. Valoriser la décision passe ou percussion.'],
  ['Dribble', 'Dribble dans trafic', 10, 'Tous les joueurs dribblent dans une zone réduite sans se toucher. Ajouter des consignes de main ou de changement de direction.'],
  ['Dribble', 'Sortie de pression', 12, 'Un attaquant reçoit dos à la pression et doit sortir proprement en dribble ou passe. Travailler calme et orientation du corps.'],
  ['Passe', 'Passe à trois avec croisement', 12, 'Trois joueurs avancent en échangeant le ballon avec croisement des courses. Chercher timing et passes dans la course.'],
  ['Passe', 'Passe pivot-remise', 10, 'Le pivot reçoit, protège et remet rapidement à un arrière lancé. Insister sur appuis forts et passe courte.'],
  ['Passe', 'Passe après fixation', 12, 'Le porteur attaque un intervalle, fixe le défenseur puis donne au partenaire libre. Travailler patience et lecture.'],
  ['Passe', 'Passe aveugle contrôlée', 8, 'Dans un cadre sécurisé, travailler des passes sans regarder directement le receveur. Objectif : vision périphérique.'],
  ['Passe', 'Relance gardien ailier', 10, 'Le gardien ou un arrière cherche rapidement l’ailier lancé. Travailler appel, trajectoire et réception en vitesse.'],
  ['Tir', 'Tir après duel 1 contre 1', 12, 'L’attaquant provoque son défenseur, gagne son intervalle puis tire. Corriger appuis, équilibre et choix d’impact.'],
  ['Tir', 'Tir après montée de balle', 12, 'Les joueurs remontent vite le terrain en passes puis terminent par un tir. L’objectif est de tirer avant le repli adverse.'],
  ['Tir', 'Tir sous fatigue', 10, 'Après un petit circuit physique court, le joueur tire en gardant précision et lucidité. Adapter l’intensité à l’âge.'],
  ['Tir', 'Tir avec choix d’impact', 10, 'Le coach annonce ou montre une zone au dernier moment. Le tireur doit adapter rapidement son impact.'],
  ['Tir', 'Tir en appui', 10, 'Travailler le tir sans suspension avec appui solide. Utile pour surprendre la défense et varier les déclenchements.'],
  ['Défense', 'Glissement défensif à deux', 12, 'Deux défenseurs coulissent ensemble selon le ballon. Objectif : rester alignés, communiquer et fermer les intervalles.'],
  ['Défense', 'Repli défensif urgence', 10, 'Après une perte de balle simulée, les joueurs sprintent en repli et se replacent entre adversaire et but.'],
  ['Défense', 'Défense sur pivot', 12, 'Travailler le placement devant ou autour du pivot sans faute. Objectif : empêcher réception et rotation facile.'],
  ['Défense', 'Sortie sur tireur', 10, 'Le défenseur sort vite sur l’arrière tireur puis revient dans l’alignement. Insister sur timing et équilibre.'],
  ['Défense', 'Communication défensive', 10, 'Défense à plusieurs avec obligation d’annoncer aide, changement et joueur libre. Valoriser la parole et l’anticipation.'],
  ['Gardien', 'Arrêts en rafale', 10, 'Série courte de tirs rapides avec replacement entre chaque ballon. Travailler concentration et vitesse de réaction.'],
  ['Gardien', 'Sortie sur contre-attaque', 8, 'Le gardien lit une balle longue et décide de sortir ou rester. Travailler prise d’information et sécurité.'],
  ['Gardien', 'Duel penalty', 10, 'Série de penalties avec consigne de lecture du tireur. Varier attente, feinte et explosivité.'],
  ['Gardien', 'Déplacement poteau à poteau', 8, 'Le gardien se déplace latéralement entre les poteaux avant chaque tir. Objectif : appuis rapides et équilibre.'],
  ['Gardien', 'Relance après arrêt', 10, 'Après l’arrêt, le gardien doit identifier vite la meilleure relance. Chercher joueur lancé et ballon exploitable.'],
  ['Collectif', 'Montée de balle à deux', 12, 'Deux joueurs remontent le terrain en passes rapides, tirent, puis deviennent défenseurs sur le binôme suivant.'],
  ['Collectif', 'Attaque placée 4 contre 4', 15, 'Mettre en place une attaque réduite avec espaces clairs. Travailler circulation, fixation et choix collectif.'],
  ['Collectif', 'Décalage jusqu’à l’aile', 12, 'Les arrières fixent successivement pour créer un surnombre jusqu’à l’ailier. Insister sur vitesse de balle.'],
  ['Collectif', 'Jeu en supériorité', 12, 'Situation 5 contre 4 ou 4 contre 3. L’équipe doit déplacer vite le ballon pour trouver le tir ouvert.'],
  ['Collectif', 'Transition attaque-défense', 15, 'Après chaque tir, les attaquants se replient immédiatement. Travailler changement de statut et effort collectif.'],
  ['Match', 'Match avec joker offensif', 12, 'Ajouter un joker toujours avec l’équipe qui attaque. Objectif : créer des solutions et travailler le surnombre.'],
  ['Match', 'Match sans dribble', 12, 'Interdire le dribble pour obliger démarquage, appels et passes rapides. Très utile pour améliorer le jeu collectif.'],
  ['Match', 'Match but après aile', 12, 'Un but compte double si l’action passe par une aile. Encourage l’écartement et le jeu sur toute la largeur.'],
  ['Match', 'Match récupération rapide', 12, 'Après perte de balle, l’équipe a quelques secondes pour récupérer. Sinon elle doit se replacer en défense organisée.'],
  ['Match', 'Match score bonus défense', 15, 'Une interception, un contre ou un repli réussi donne un point bonus. Valorise l’effort défensif.'],
  ['Physique', 'Circuit appuis et tir', 12, 'Enchaîner appuis rapides, sprint court, réception de balle et tir. Travailler explosivité utile au jeu.'],
  ['Physique', 'Duel vitesse réaction', 8, 'Deux joueurs partent au signal vers un ballon ou une zone. Varier les positions de départ.'],
  ['Physique', 'Sauts contrôlés', 8, 'Petits sauts verticaux et latéraux avec réception stable. Objectif : coordination, équilibre et prévention.'],
  ['Physique', 'Sprint repli montée', 10, 'Sprint vers l’avant puis retour défensif immédiat. Reproduire les efforts répétés du match.'],
  ['Physique', 'Circuit gainage passes', 10, 'Gainage court puis passe précise au partenaire. Alterner effort physique et geste technique propre.'],
  ['Retour au calme', 'Retour technique lent', 6, 'Réaliser quelques passes et tirs très contrôlés à faible intensité pour finir proprement.'],
  ['Retour au calme', 'Cercle des réussites', 5, 'Chaque joueur cite une action positive d’un partenaire. Renforce confiance et cohésion.'],
  ['Retour au calme', 'Étirements par binôme', 6, 'Par deux, étirements simples et contrôlés. Le coach rappelle les zones sollicitées pendant la séance.'],
  ['Retour au calme', 'Bilan objectif séance', 5, 'Revenir sur l’objectif du jour : ce qui a progressé, ce qui reste à travailler, et la consigne pour la prochaine fois.'],
  ['Retour au calme', 'Challenge précision léger', 6, 'Petit défi de tirs ou passes de précision sans intensité physique. Finir sur une note ludique et calme.'],
  ...
  function buildSupporterSummary(match: MatchItem, actionText = '') {
    ...
    if (actionLines.length > 0) {
      ...
      const topScorersBlock = [
        '\n\n\uD83D\uDD25 Top buteurs',
        summaryTeamName,
        ...teamTopScorers.slice(0, 3).map(([name, goals]) => `${name} \u2014 ${goals} but${goals > 1 ? 's' : ''}`),
        opponent,
    ...
    try {
      ...
      if (importedStats.length > 0) {
        try {
          ...
          statsImportError = statsError?.message || String(statsError);
        }
      }
      ...
      alert(statsImported
        ...
        : importedStats.length > 0
          ? `Resume + score enregistres. Les stats detectees n'ont pas pu etre ajoutees automatiquement : ${statsImportError}`
          : "Resume supporter genere. Aucune stat joueur n'a pu etre reliee automatiquement.");
    } catch (e: any) {
      console.error(e);
      alert(`Erreur import feuille de match : ${e?.message || String(e)}`);
    } finally {
